...
template <class T>
Edge<T>::Edge(Vertex<T> *orig, Vertex<T> *dest, double driving, double walking): orig(orig), dest(dest) {
  this->weight[0] = driving;
  this->weight[1] = walking;
}
...
template <class T>
double Edge<T>::getWeightD() const {
    return this->weight[0];
}

template <class T>
double Edge<T>::getWeightW() const {
